...
![]({{ site.url-pfx }}/assets/images/fonts/dsegstended.png){: .showcase .sc-full}
...
[Download]({{ site.url-pfx }}/assets/fonts/fontstruct/pixtura-corvida.ttf) {{ site.sep_char }} [Fontstruct](https://www.fontstruct.com/fontstructions/show/1954327/)
...
![]({{ site.url-pfx }}/assets/images/fonts/fontstruct/pixtura-corvida.png){: .showcase .sc-full}

---

### Ocean Vice (Proto)

[Download]({{ site.url-pfx }}/assets/fonts/fontstruct/ocean-vice-proto.ttf) {{ site.sep_char }} [Fontstruct](https://www.fontstruct.com/fontstructions/show/1950206/)
...
![]({{ site.url-pfx }}/assets/images/fonts/fontstruct/ocean-vice.png){: .showcase .sc-full}

---

### Info Seventy

[Download]({{ site.url-pfx }}/assets/fonts/fontstruct/info-70.ttf) {{ site.sep_char }} [Fontstruct](https://www.fontstruct.com/fontstructions/show/1797228/)

my own implementation of the classic info 70 font. i know there are plenty out there, but this one's mine.

![]({{ site.url-pfx }}/assets/images/fonts/fontstruct/info-seventy.png){: .showcase .sc-full}

---

### Various Pixelfonts

Tiny: [Download]({{ site.url-pfx }}/assets/fonts/fontstruct/tiny-mono.ttf) {{ site.sep_char }} [Fontstruct](https://www.fontstruct.com/fontstructions/show/1837063/) {{ site.sep_char }} Rounded: [Download]({{ site.url-pfx }}/assets/fonts/fontstruct/rounded-pixelfont.ttf) {{ site.sep_char }} [Fontstruct](https://www.fontstruct.com/fontstructions/show/1411349/) {{ site.sep_char }} Inverted: [Download]({{ site.url-pfx }}/assets/fonts/fontstruct/rounded-pixelfont.ttf) {{ site.sep_char }} [Fontstruct](https://www.fontstruct.com/fontstructions/show/1418874/)
...
![]({{ site.url-pfx }}/assets/images/fonts/fontstruct/various-pixelfonts.png){: .showcase .sc-full}

---

### Irid Novan

Smooth: [Download]({{ site.url-pfx }}/assets/fonts/fontstruct/irid-novan-smooth.ttf) {{ site.sep_char }} [Fontstruct](https://www.fontstruct.com/fontstructions/show/1960809/) {{ site.sep_char }} Sharp: [Download]({{ site.url-pfx }}/assets/fonts/fontstruct/irid-novan-sharp.ttf) {{ site.sep_char }} [Fontstruct](https://www.fontstruct.com/fontstructions/show/1960792/)
...
![]({{ site.url-pfx }}/assets/images/fonts/fontstruct/irid-novan.png){: .showcase .sc-full}
