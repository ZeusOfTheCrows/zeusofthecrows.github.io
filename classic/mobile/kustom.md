...
![Wood Panelling Preview]({{ site.url-pfx }}/assets/images/mobile/kustom/wood_panelling_01.png){: .showcase .sc-full .sc-carousel}

![Wood Panelling Preview]({{ site.url-pfx }}/assets/images/mobile/kustom/wood_panelling_02.png){: .showcase .sc-full .sc-carousel}

![Wood Panelling Preview]({{ site.url-pfx }}/assets/images/mobile/kustom/wood_panelling_03.png){: .showcase .sc-full .sc-carousel}

<video class="showcase sc-full sc-carousel" controls>
	<source src="{{ site.url-pfx }}/assets/images/mobile/kustom/wood_panelling_04.mp4" alt="Wood Panelling Preview Video" type="video/mp4"/>
</video>
...
![Retro Gruvbox Preview]({{ site.url-pfx }}/assets/images/mobile/kustom/retro_gruvbox.png){: .showcase .sc-full .sc-carousel}
...
![Casio W-86 Preview]({{ site.url-pfx }}/assets/images/mobile/kustom/casio_w_86_illuminator.png){: .showcase .sc-full .sc-carousel}
...
![Kustomfetch Preview]({{ site.url-pfx }}/assets/images/mobile/kustom/kustomfetch.png){: .showcase .sc-full .sc-carousel}
...
![Amber Terminal Preview]({{ site.url-pfx }}/assets/images/mobile/kustom/amber_terminal.png){: .showcase .sc-full .sc-carousel}
...
![Amber Terminal Preview]({{ site.url-pfx }}/assets/images/mobile/kustom/outrun_widgy.png){: .showcase .sc-wide .sc-top}
