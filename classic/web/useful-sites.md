...
**this page has been deprecated, and will not be updated**
...
- [textanim](https://textanim.com/): create animated word art-esque gifs [like so]({{ site.url-pfx }}/assets/images/web/useful/zeus-upward-lines.gif)
