...
![Amber Dec Terminal Preview]({{ site.url-pfx }}/assets/images/desktops/wpe/amber-dec-terminal.png){: .showcase .sc-wide .sc-mid}

---

## Dieselpunk Train Town

[Workshop (dm)](https://steamcommunity.com/sharedfiles/filedetails/?id=2807544134) {{ site.sep_char }} [Workshop (uw)](https://steamcommunity.com/sharedfiles/filedetails/?id=2807437541) {{ site.sep_char }} [Source (dm)](https://github.com/ZeusOfTheCrows/nsx-button-prompts/releases/download/train-town-wpe/dieselpunk-train-town-dm.7z) {{ site.sep_char }} [Source (uw)](https://github.com/ZeusOfTheCrows/nsx-button-prompts/releases/download/train-town-wpe/dieselpunk-train-town-uw.7z) {{ site.sep_char }} [Source (xcf)](https://github.com/ZeusOfTheCrows/nsx-button-prompts/releases/download/train-town-wpe/dieselpunk-train-town-gimp.7z)
...
![Amber Dec Terminal Preview]({{ site.url-pfx }}/assets/images/desktops/wpe/dieselpunk-train-town.png){: .showcase .sc-wide .sc-mid}
...
![Commodore Amiga 500 Preview]({{ site.url-pfx }}/assets/images/desktops/wpe/commodore-amiga-500.png){: .showcase .sc-wide .sc-mid}
...
![Retrowave XP Bliss Preview]({{ site.url-pfx }}/assets/images/desktops/wpe/retrowave-xp-bliss.png){: .showcase .sc-wide .sc-mid}
