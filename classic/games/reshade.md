...
<a href="{{ site.url-pfx }}/assets/text/reshade/blasphemous-crt-aesthetic.ini" download>download</a> {{ site.sep_char }} [sfx repo](https://sfx.thelazy.net/games/preset/12125/)
...
<div class="reshade-container">
	<a href="{{ site.url-pfx }}/assets/images/games/reshade/blasphemous-after.png">
		<img src="{{ site.url-pfx }}/assets/images/games/reshade/blasphemous-after.png"
			class="showcase sc-wide sc-mid sc-rs-after"
			alt="crt æsthetic for blasphemous - after" />
		<img src="{{ site.url-pfx }}/assets/images/games/reshade/blasphemous-before.png"
...
<a href="{{ site.url-pfx }}/assets/text/reshade/dev-sys-crt-aesthetic.ini" download>download</a>
...
<div class="reshade-container">
	<a href="{{ site.url-pfx }}/assets/images/games/reshade/ooe-after.png">
		<img src="{{ site.url-pfx }}/assets/images/games/reshade/ooe-after.png"
			class="showcase sc-wide sc-mid sc-rs-after"
			alt="crt æsthetic for castlevania: ooe - after" />
		<img src="{{ site.url-pfx }}/assets/images/games/reshade/ooe-before.png"
			class="showcase sc-wide sc-mid sc-rs-before"
...
<a href="{{ site.url-pfx }}/assets/text/reshade/timespinner-crt-aesthetic.ini" download>download</a>
...
<div class="reshade-container">
	<a href="{{ site.url-pfx }}/assets/images/games/reshade/timespinner-after.png">
		<img src="{{ site.url-pfx }}/assets/images/games/reshade/timespinner-after.png"
			class="showcase sc-wide sc-mid sc-rs-after"
			alt="crt æsthetic for timespinner - after" />
		<img src="{{ site.url-pfx }}/assets/images/games/reshade/timespinner-before.png"
			class="showcase sc-wide sc-mid sc-rs-before"
...
<a href="{{ site.url-pfx }}/assets/text/reshade/kennykids-universal-preset.ini" download>download</a>
