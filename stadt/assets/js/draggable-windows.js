// store window list as var:
var draggableElements = document.getElementsByClassName("window-9x");

// call function for each var
...
function dragElement(elmnt) {
	...
	if (elmnt.getElementsByClassName("window-titlebar")[0]) {
